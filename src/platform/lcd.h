...
//   Copied from Picoware/src/SDK/Picoware/src/system/drivers/lcd.h at Picoware 841d9c56.
...
// PORT: font.h renamed to font5x10.h; only the 5x10 font is vendored.
#include "font5x10.h"
...
extern "C"
{
    ...
    uint lcd_get_baudrate(void); // PORT: added
